...
// 平台管理-商户权限修改
export const reqEditBusinessPermission = (params: any) => http.post(PORT1 + "/t-role", params);

// 平台管理-商户权限删除
export const reqDelBusinessPermission = (id: number) => http.delete(PORT1 + `/t-role/${id}`);

// 平台管理-商户权限-获取权限树
export const reqGetPermissionTree = (id: number) => http.get<any>(PORT1 + `/t-role/selectCheck/${id}`, {}, { noLoading: true });
