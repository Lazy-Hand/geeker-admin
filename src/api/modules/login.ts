import { Login, PresentMenu } from "@/api/interface/index";
...
export const loginApi = (params: Login.ReqLoginForm) => {
  return http.post<UserInfo>(PORT1 + `/login/passwd`, params, { noLoading: true }); // 正常 post json 请求  ==>  application/json
...
export const getAuthMenuListApi = () => {
  return http.get<PresentMenu.Datum[]>(PORT1 + `/menu`, {}, { noLoading: true });
